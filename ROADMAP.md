...
Priority order: complete the **Final Big Five season 2024 production proof**; **Product Phase 5 — Scouting BI P1** is complete. Avoid auth, provider reconciliation, and schema-heavy watchlists unless explicitly requested.
